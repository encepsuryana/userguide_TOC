! function(e) {
    ...
    var i = function() {
        function e(t, o, n) {
            void 0 === o && (o = !1), void 0 === n && (n = e), this.name = "", this.isEmptyFolder = !1, this.setData(t), this.children = [], this.parent = null, o && (this.idMapping = {}, this.tree = this, this.nodeClass = n)
        }
        return e.prototype.setData = function(e) {
            ...
            for (var t = 0, o = e; t < o.length; t++) {
                ...
                this.addChild(r), "object" == typeof n && n.children && (0 === n.children.length ? r.isEmptyFolder = !0 : r.loadFromData(n.children))
            }
            ...
            e.parent && !e.isParentOf(t) && (e.parent.doRemoveChild(e), o === n.After ? t.parent && t.parent.addChildAtPosition(e, t.parent.getChildIndex(t) + 1) : o === n.Before ? t.parent && t.parent.addChildAtPosition(e, t.parent.getChildIndex(t)) : o === n.Inside && t.addChildAtPosition(e, 0))
        }, e.prototype.getData = function(e) {
            function t(e) {
                return e.map(function(e) {
                    var o = {};
                    for (var n in e)
                        if (-1 === ["parent", "children", "element", "tree", "isEmptyFolder"].indexOf(n) && Object.prototype.hasOwnProperty.call(e, n)) {
                            var r = e[n];
                            o[n] = r
                        }
        ...
        return e.register = function(t, o) {
            ...
            jQuery.fn[o] = function(e) {
                ...
                if ("string" == typeof e && "_" !== e[0]) {
                    var l = e;
                    return "destroy" === l ? s(this) : "get_widget_class" === l ? t : a(this, l, o)
                }
            }
        ...
        _ = function(e) {
            function t() {
                ...
                return t.handleClick = function(e) {
                    ...
                    var o = a(e.target).closest("ul.jquser-tree .jquser-element");
                    if (o.length) {
                        var n = t.getNode(o);
            ...
            return r(t, e), t.prototype.toggle = function(e, t) {
                ...
                return "string" == typeof e ? this.doLoadDataFromUrl(e, t, o) : this.doLoadDataFromUrl(null, e, t), this.element
                ...
                var r = function() {
                        var e, r;
                        return y.isFunction(t) ? (e = t, r = null) : (r = t, e = o), null == r && (r = n.options.slide), [r, e]
                    }(),
                    i = r[0],
                    s = r[1];
                ...
                if (!e) throw Error(S);
                var o = null == t ? this.options.slide : t;
                return (e.isFolder() || e.isEmptyFolder) && (new N.FolderElement(e, this).close(o, this.options.animationSpeed), this.saveState()), this.element
                ...
                if (!e) throw Error(S);
                var t = e;
                if (t.parent && this.selectNodeHandler) {
                    this.selectNodeHandler.removeFromSelection(t, !0);
                    var o = t.parent;
                    t.remove(), this._refreshElements(o)
                }
                return this.element
                ...
                return o && this.tree.removeNodeFromIndex(e), e.setData(t), o && this.tree.addNodeToIndex(e), "object" == typeof t && t.children && (e.removeChildren(), t.children.length && e.loadFromData(t.children)), this._refreshElements(e), this.selectCurrentNode(), this.element
                ...
                if (!e) throw Error(S);
                var o = e;
                return this.selectNodeHandler && (this.selectNodeHandler.addToSelection(o), this._getNodeElementForNode(o).select(void 0 === t || t), this.saveState()), this.element
                ...
                if (!e) throw Error(S);
                return this.selectNodeHandler && (this.selectNodeHandler.removeFromSelection(e), this._getNodeElementForNode(e).deselect(), this.saveState()), this.element
            }, t.prototype.scrollToNode = function(e) {
                if (!e) throw Error(S);
                if (this.scrollHandler) {
                    var t = a(e.element).offset(),
                        o = t ? t.top : 0,
                        n = this.$el.offset(),
                        r = o - (n ? n.top : 0);
                ...
                return this.saveStateHandler && (this.saveStateHandler.setInitialState(e), this._refreshElements(null)), this.element
                ...
                return this.dndHandler ? (this.dndHandler.currentItem = this._getNodeElementForNode(e), this.dndHandler.generateHitAreas(), this.dndHandler.hitAreas) : []
            }, t.prototype._triggerEvent = function(e, t) {
                var o = a.Event(e);
                return a.extend(o, t), this.element.trigger(o), o
            }, t.prototype._openNode = function(e, t, o) {
                var n = this;
                void 0 === t && (t = !0);
                var r = function(e, t, o) {
                    new N.FolderElement(e, n).open(o, t, n.options.animationSpeed)
                };
                ...
                return e.isFolder() ? new N.FolderElement(e, this) : new N.NodeElement(e, this)
                ...
                var t = this.getNode(a(e));
                return null != t && t.tree === this.tree
            }, t.prototype._getScrollLeft = function() {
                var e;
                return (null === (e = null == this ? void 0 : this.scrollHandler) || void 0 === e ? void 0 : e.getScrollLeft()) || 0
            }, t.prototype.init = function() {
                e.prototype.init.call(this), this.element = this.$el, this.mouseDelay = 300, this.isInitialized = !1, this.options.rtl = this.getRtlOption(), null === this.options.closedIcon && (this.options.closedIcon = this.getDefaultClosedIcon()), this.renderer = new d.default(this), this.dataLoader = new u.default(this), null != c.default ? this.saveStateHandler = new c.default(this) : this.options.saveState = !1, null != g.default && (this.selectNodeHandler = new g.default(this)), null != l.DragAndDropHandler ? this.dndHandler = new l.DragAndDropHandler(this) : this.options.dragAndDrop = !1, null != f.default && (this.scrollHandler = new f.default(this)), null != h.default && null != g.default && (this.keyHandler = new h.default(this)), this.initData(), this.element.click(this.handleClick), this.element.dblclick(this.handleDblclick), this.options.useContextMenu && this.element.on("contextmenu", this.handleContextmenu)
            }, t.prototype.deinit = function() {
                this.element.empty(), this.element.off(), this.keyHandler && this.keyHandler.deinit(), this.tree = new v.Node({}, !0), e.prototype.deinit.call(this)
                ...
                this.tree = new this.options.nodeClass(null, !0, this.options.nodeClass), this.selectNodeHandler && this.selectNodeHandler.clear(), this.tree.loadFromData(e);
                ...
                if (o.length) {
                    ...
                    var n, r = t.closest(".jquser-element");
                    if (r.length)
                ...
                if (this.selectNodeHandler) {
                    ...
                    if (o.options.onCanSelectNode ? o.options.selectable && o.options.onCanSelectNode(e) : o.options.selectable) {
                        var s, a = e;
                        if (this.selectNodeHandler.isNodeSelected(a)) n.mustToggle && (this.deselectCurrentNode(), this._triggerEvent("tree.select", {
                            node: null,
                            previous_node: a
                        }));
                        else {
                            var l = this.getSelectedNode();
                            this.deselectCurrentNode(), this.addToSelection(a, n.mustSetFocus), this._triggerEvent("tree.select", {
                                node: a,
                                deselected_node: l
                ...
                e && (this._triggerEvent("tree.load_data", {
                    tree_data: e
                }), t ? (this.deselectNodes(t), this.loadSubtree(e, t)) : this.initTree(e), this.isDragging() && this.dndHandler && this.dndHandler.refresh())
            ...
            return e.prototype.mouseCapture = function(e) {
                ...
                if (this.currentItem && void 0 !== e.pageX && void 0 !== e.pageY) {
                    ...
                    var t = i(e.target).offset(),
                        ...
                        s = this.treeWidget.options.autoEscape ? a.htmlEscape(r.name) : r.name;
                    return this.dragElement = new u(s, e.pageX - o, e.pageY - n, this.treeWidget.element), this.isDragging = !0, this.positionInfo = e, this.currentItem.$element.addClass("jquser-moving"), !0
                }
                return !1
                ...
                if (this.currentItem && this.dragElement && void 0 !== e.pageX && void 0 !== e.pageY) {
                    ...
                    return this.canMoveToArea(t) && t ? (t.node.isFolder() || this.stopOpenFolderTimer(), this.hoveredArea !== t && (this.hoveredArea = t, this.mustOpenFolderTimer(t) ? this.startOpenFolderTimer(t.node) : this.stopOpenFolderTimer(), this.updateDropHint())) : (this.removeHover(), this.removeDropHint(), this.stopOpenFolderTimer()), t || this.treeWidget.options.onDragMove && this.treeWidget.options.onDragMove(this.currentItem.node, e.originalEvent), !0
                }
                return !1
            }, e.prototype.mouseStop = function(e) {
                this.moveItem(e), this.clear(), this.removeHover(), this.removeDropHint(), this.removeHitAreas();
                var t = this.currentItem;
                return this.currentItem && (this.currentItem.$element.removeClass("jquser-moving"), this.currentItem = null), this.isDragging = !1, this.positionInfo = null, !this.hoveredArea && t && this.treeWidget.options.onDragStop && this.treeWidget.options.onDragStop(t.node, e.originalEvent), !1
            }, e.prototype.refresh = function() {
                this.removeHitAreas(), this.currentItem && (this.generateHitAreas(), this.currentItem = this.treeWidget._getNodeElementForNode(this.currentItem.node), this.isDragging && this.currentItem.$element.addClass("jquser-moving"))
                ...
                var t = this;
                if (this.currentItem && this.hoveredArea && this.hoveredArea.position !== s.Position.None && this.canMoveToArea(this.hoveredArea)) {
    ...
    var d = function(e) {
        ...
        return r(t, e), t.prototype.generate = function() {
            ...
            return e !== this.currentNode && (e.children[0] !== this.currentNode && this.addPosition(e, s.Position.Inside, this.getTop(t)), !0)
        }, t.prototype.handleClosedFolder = function(e, t, o) {
            var n = this.getTop(o);
            e === this.currentNode ? this.addPosition(e, s.Position.None, n) : (this.addPosition(e, s.Position.Inside, n), t !== this.currentNode && this.addPosition(e, s.Position.After, n))
        }, t.prototype.handleFirstNode = function(e) {
            e !== this.currentNode && this.addPosition(e, s.Position.Before, this.getTop(i(e.element)))
        }, t.prototype.handleAfterOpenFolder = function(e, t) {
            e === this.currentNode || t === this.currentNode ? this.addPosition(e, s.Position.None, this.lastTop) : this.addPosition(e, s.Position.After, this.lastTop)
        }, t.prototype.handleNode = function(e, t, o) {
            var n = this.getTop(o);
            e === this.currentNode ? this.addPosition(e, s.Position.None, n) : this.addPosition(e, s.Position.Inside, n), t === this.currentNode || e === this.currentNode ? this.addPosition(e, s.Position.None, n) : this.addPosition(e, s.Position.After, n)
        ...
        return e.prototype.iterate = function() {
            var e = this,
                t = !0,
                o = function(n, r) {
                    var s = (n.is_open || !n.element) && n.hasChildren(),
                        a = null;
                    if (n.element) {
    ...
    var u = function() {
        function e(e, t, o, n) {
            this.offsetX = t, this.offsetY = o, this.$element = i('<span class="jquser-title jquser-dragging">' + e + "</span>"), this.$element.css("position", "absolute"), n.append(this.$element)
        }
    ...
    var n = o(1),
        r = function() {
            ...
            return e.prototype.render = function(e) {
                ...
                var t, o;
                e ? (t = "jquser-tree", o = "tree", this.treeWidget.options.rtl && (t += " jquser-rtl")) : (t = "", o = "group");
                var n = document.createElement("ul");
                return n.className = "jquser_common " + t, n.setAttribute("role", o), n
                ...
                s.className = "jquser_common " + r, s.setAttribute("role", "presentation");
                var a = document.createElement("div");
                a.className = "jquser-element jquser_common", a.setAttribute("role", "presentation"), s.appendChild(a);
                ...
                var n = ["jquser_common"];
                o && n.push("jquser-selected");
                var r = n.join(" "),
                    i = document.createElement("li");
                i.className = r, i.setAttribute("role", "presentation");
                var s = document.createElement("div");
                return s.className = "jquser-element jquser_common", s.setAttribute("role", "presentation"), i.appendChild(s), s.appendChild(this.createTitleSpan(e.name, t, o, e.is_open, !1)), i
            }, e.prototype.createTitleSpan = function(e, t, o, r, i) {
                var s = document.createElement("span"),
                    a = "jquser-title jquser_common";
                return i && (a += " jquser-title-folder"), s.className = a, s.setAttribute("role", "treeitem"), s.setAttribute("aria-level", "" + t), s.setAttribute("aria-selected", n.getBoolString(o)), s.setAttribute("aria-expanded", n.getBoolString(r)), o && s.setAttribute("tabindex", this.treeWidget.options.tabIndex), s.innerHTML = this.escapeIfNecessary(e), s
            }, e.prototype.getButtonClasses = function(e) {
                var t = ["jquser-toggler", "jquser_common"];
                return e.is_open || t.push("jquser-closed"), this.treeWidget.options.buttonLeft ? t.push("jquser-toggler-left") : t.push("jquser-toggler-right"), t.join(" ")
            }, e.prototype.getFolderClasses = function(e, t) {
                var o = ["jquser-folder"];
                return e.is_open || o.push("jquser-closed"), t && o.push("jquser-selected"), e.is_loading && o.push("jquser-loading"), o.join(" ")
    ...
    var n = function() {
        ...
        return e.prototype.loadFromUrl = function(e, t, o) {
            ...
            e && e.addClass("jquser-loading")
        }, e.prototype.removeLoadingClass = function(e) {
            e && e.removeClass("jquser-loading")
            ...
            n && n(e, t, o), this.treeWidget._triggerEvent("tree.loading_data", {
                isLoading: e,
                node: t,
                $el: o
            })
    ...
    var n = function() {
        function e(t) {
            ...
            }, this.treeWidget = t, t.options.keyboardSupport && jQuery(document).on("keydown.jquser", this.handleKeyDown)
        }
        return e.prototype.deinit = function() {
            jQuery(document).off("keydown.jquser")
            ...
            return !e || (this.treeWidget.selectNode(e), this.treeWidget.scrollHandler && !this.treeWidget.scrollHandler.isScrolledIntoView(jQuery(e.element).find(".jquser-element")) && this.treeWidget.scrollToNode(e), !1)
    ...
    var i = function(e) {
        function t() {
            ...
            return t.mouseDown = function(e) {
                if (1 === e.which) {
                    var o = t.handleMouseDown(t.getPositionInfo(e));
                    return o && e.preventDefault(), o
                }
            }, t.mouseMove = function(e) {
                return t.handleMouseMove(e, t.getPositionInfo(e))
            }, t.mouseUp = function(e) {
                return t.handleMouseUp(t.getPositionInfo(e))
            }, t.touchStart = function(e) {
                var o = e.originalEvent;
                if (!(o.touches.length > 1)) {
                    var n = o.changedTouches[0];
                    return t.handleMouseDown(t.getPositionInfo(n))
                }
            }, t.touchMove = function(e) {
                var o = e.originalEvent;
                if (!(o.touches.length > 1)) {
                    var n = o.changedTouches[0];
                    return t.handleMouseMove(e, t.getPositionInfo(n))
                }
            }, t.touchEnd = function(e) {
                var o = e.originalEvent;
                if (!(o.touches.length > 1)) {
                    var n = o.changedTouches[0];
                    return t.handleMouseUp(t.getPositionInfo(n))
                }
            }, t
        }
        return r(t, e), t.prototype.setMouseDelay = function(e) {
            ...
            this.$el.on("mousedown.mousewidget", this.mouseDown), this.$el.on("touchstart.mousewidget", this.touchStart), this.isMouseStarted = !1, this.mouseDelay = 0, this.mouseDelayTimer = null, this.isMouseDelayMet = !0, this.mouseDownInfo = null
        }, t.prototype.deinit = function() {
            ...
            if (this.isMouseStarted && this.handleMouseUp(e), this.mouseDownInfo = e, this.mouseCapture(e)) return this.handleStartMouse(), !0
        }, t.prototype.handleStartMouse = function() {
            var e = jQuery(document);
            e.on("mousemove.mousewidget", this.mouseMove), e.on("touchmove.mousewidget", this.touchMove), e.on("mouseup.mousewidget", this.mouseUp), e.on("touchend.mousewidget", this.touchEnd), this.mouseDelay && this.startMouseDelayTimer()
            ...
            this.mouseDelayTimer && clearTimeout(this.mouseDelayTimer), this.mouseDelayTimer = window.setTimeout(function() {
                e.isMouseDelayMet = !0
            }, this.mouseDelay), this.isMouseDelayMet = !1
        }, t.prototype.handleMouseMove = function(e, t) {
            return this.isMouseStarted ? (this.mouseDrag(t), e.preventDefault()) : !(!this.mouseDelay || this.isMouseDelayMet) || (this.mouseDownInfo && (this.isMouseStarted = !1 !== this.mouseStart(this.mouseDownInfo)), this.isMouseStarted ? this.mouseDrag(t) : this.handleMouseUp(t), !this.isMouseStarted)
        }, t.prototype.getPositionInfo = function(e) {
            return {
                pageX: e.pageX,
                pageY: e.pageY,
                target: e.target,
            ...
            t.off("mousemove.mousewidget"), t.off("touchmove.mousewidget"), t.off("mouseup.mousewidget"), t.off("touchend.mousewidget"), this.isMouseStarted && (this.isMouseStarted = !1, this.mouseStop(e))
        }, t
    }(o(3).default);
    t.default = i
}, function(e, t, o) {
    ...
    var n = o(1),
        r = function() {
            ...
            return e.prototype.saveState = function() {
                ...
                var e, t = this;
                return {
                    open_nodes: (e = [], t.treeWidget.tree.iterate(function(t) {
                        return t.is_open && t.id && t.hasChildren() && e.push(t.id), !0
                    }), e),
                    selected_node: t.treeWidget.getSelectedNodes().map(function(e) {
                        return e.id
                    })
                }
                ...
                return this.treeWidget.options.onGetStateFromStorage ? this.treeWidget.options.onGetStateFromStorage() : this.supportsLocalStorage() ? localStorage.getItem(this.getKeyName()) : void 0
                ...
                var n = this,
                    ...
                    s = function() {
                        for (var e = [], s = 0, l = i; s < l.length; s++) {
                            ...
                            u ? u.is_loading || (u.load_on_demand ? a(u) : n.treeWidget._openNode(u, !1, null)) : e.push(d)
                        }
    ...
    var n = function() {
        ...
        return e.prototype.getSelectedNode = function() {
            ...
            return !!e && (null != e.id ? !!this.selectedNodes[e.id] : !!this.selectedSingleNode && this.selectedSingleNode.element === e.element)
        }, e.prototype.clear = function() {
            this.selectedNodes = {}, this.selectedSingleNode = null
        }, e.prototype.removeFromSelection = function(e, t) {
            var o = this;
            void 0 === t && (t = !1), null == e.id ? this.selectedSingleNode && e.element === this.selectedSingleNode.element && (this.selectedSingleNode = null) : (delete this.selectedNodes[e.id], t && e.iterate(function() {
    ...
    var i = o(0),
        s = function() {
            ...
            return e.prototype.init = function(e, t) {
                ...
                return this.mustShowBorderDropHint(e) ? new l(this.$element, this.treeWidget._getScrollLeft()) : new d(this.node, this.$element, e)
            }, e.prototype.select = function(e) {
                var t = this.getLi();
                t.addClass("jquser-selected"), t.attr("aria-selected", "true");
                var o = this.getSpan();
                o.attr("tabindex", this.treeWidget.options.tabIndex), e && o.focus()
            }, e.prototype.deselect = function() {
                var e = this.getLi();
                e.removeClass("jquser-selected"), e.attr("aria-selected", "false");
                var t = this.getSpan();
                t.removeAttr("tabindex"), t.blur()
            }, e.prototype.getUl = function() {
                return this.$element.children("ul:first")
            }, e.prototype.getSpan = function() {
                return this.$element.children(".jquser-element").find("span.jquser-title")
    ...
    var a = function(e) {
        ...
        return r(t, e), t.prototype.open = function(e, t, o) {
            ...
            if (void 0 === t && (t = !0), void 0 === o && (o = "fast"), !this.node.is_open) {
                ...
                r.removeClass("jquser-closed"), r.html("");
                var i = r.get(0);
                if (i) {
                ...
                var a = function() {
                    n.getLi().removeClass("jquser-closed"), n.getSpan().attr("aria-expanded", "true"), e && e(n.node), n.treeWidget._triggerEvent("tree.open", {
                        node: n.node
                    })
                };
            ...
            if (void 0 === e && (e = !0), void 0 === t && (t = "fast"), this.node.is_open) {
                ...
                n.addClass("jquser-closed"), n.html("");
                var r = n.get(0);
                if (r) {
                ...
                var s = function() {
                    o.getLi().addClass("jquser-closed"), o.getSpan().attr("aria-expanded", "false"), o.treeWidget._triggerEvent("tree.close", {
                        node: o.node
                    })
                };
            ...
            return this.$element.children(".jquser-element").find("a.jquser-toggler")
        }, t
    }(s);
    t.FolderElement = a;
    var l = function() {
        function e(e, t) {
            var o = e.children(".jquser-element"),
                n = e.width() || 0,
                r = Math.max(n + t - 4, 0),
                i = o.outerHeight() || 0,
                s = Math.max(i - 4, 0);
            this.$hint = jQuery('<span class="jquser-border"></span>'), o.append(this.$hint), this.$hint.css({
                width: r,
                height: s
            })
        }
    ...
    var d = function() {
        function e(e, t, o) {
            this.$element = t, this.node = e, this.$ghost = jQuery('<li class="jquser_common jquser-ghost"><span class="jquser_common jquser-circle"></span>\n            <span class="jquser_common jquser-line"></span></li>'), o === i.Position.After ? this.moveAfter() : o === i.Position.Before ? this.moveBefore() : o === i.Position.Inside && (e.isFolder() && e.is_open ? this.moveInsideOpenFolder() : this.moveInside())
        }
        return e.prototype.remove = function() {
            this.$ghost.remove()
            ...
            this.$element.after(this.$ghost), this.$ghost.addClass("jquser-inside")
        }, e
    }()
}, , function(e, t, o) {
    e.exports = o(4)
